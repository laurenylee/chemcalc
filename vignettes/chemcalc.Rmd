...
You can also use more complex formulas with multiple elements and counts. This is useful in stoichiometry problems where you need the molar mass to convert between grams and moles.
